...
class surReal_SiamUnet_diff4(nn.Module):
 ...
 '''
    ...
    def forward(self, x1, x2):
        x11 = ReLU4Dsp(self.conv11(x1))
        x11 = ReLU4Dsp(self.conv12(x11))
        x12_1 = self.dist1(x11)
        
        x21 = ReLU4Dsp(self.conv21(x11))
        x21 = ReLU4Dsp(self.conv22(x21))
        x22_1 = self.dist2(x21)
        
        x31 = ReLU4Dsp(self.conv31(x21))
        x31 = ReLU4Dsp(self.conv32(x31))
        x32_1 = self.dist3(x31)
        
        x41 = ReLU4Dsp(self.conv41(x31))
        x41 = ReLU4Dsp(self.conv42(x41))
        x42_1 = self.dist4(x41)

        ##########################################
        x11 = ReLU4Dsp(self.conv11(x2))
        x11 = ReLU4Dsp(self.conv12(x11))
