...
class surReal_SiamUnet_diff(nn.Module):
 ...
 '''
    ...
    def __init__(self, input_nbr, label_nbr, drop_p=0.2):
        ...
        # surReal part
        self.surreal_conv1 = ComplexConv2Deffgroup(input_nbr, 16, kern_size=(3,3), stride=(1,1), padding=(1,1))
        self.surreal_conv2 = ComplexConv2Deffgroup(16, 16, kern_size=(3,3), stride=(1,1), padding=(1,1))
        self.surreal_proj2 = cp(16)
        self.surreal_linear1 = ComplexLinearangle2Dmw_outfield(16*512**2)
    ...
    def forward(self, x1, x2):
        ...
        x11 = self.surreal_proj2(x11)
        x12_1 = self.surreal_linear1(x11)
        ...
        x11 = self.surreal_conv2(x11)
        x11 = self.surreal_proj2(x11)
        x12_2 = self.surreal_linear1(x11)
