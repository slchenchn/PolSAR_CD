...
class complex_SiamUnet_diff(nn.Module):
    ...
    def __init__(self, input_nbr, label_nbr, drop_p=0.2, channel_scale=0.5):
        ...
        self.bn12 = NaiveComplexBatchNorm2d(int(16*channel_scale))
        ...
        self.bn21 = NaiveComplexBatchNorm2d(int(32*channel_scale))
        ...
        self.bn22 = NaiveComplexBatchNorm2d(int(32*channel_scale))
        ...
        self.bn31 = NaiveComplexBatchNorm2d(int(64*channel_scale))
        ...
        self.bn32 = NaiveComplexBatchNorm2d(int(64*channel_scale))
        ...
        self.bn33 = NaiveComplexBatchNorm2d(int(64*channel_scale))
        ...
        self.bn41 = NaiveComplexBatchNorm2d(int(128*channel_scale))
        ...
        self.bn42 = NaiveComplexBatchNorm2d(int(128*channel_scale))
        ...
        self.upconv4 = ComplexConvTranspose2d(int(128*channel_scale), int(128*channel_scale), kernel_size=3, padding=1, stride=2, output_padding=1)

        self.conv43d = ComplexConvTranspose2d(int(256*channel_scale), int(128*channel_scale), kernel_size=3, padding=1)
        self.bn43d = NaiveComplexBatchNorm2d(int(128*channel_scale))
        self.do43d = ComplexDropout2d(drop_p)
        self.conv42d = ComplexConvTranspose2d(int(128*channel_scale), int(128*channel_scale), kernel_size=3, padding=1)
        self.bn42d = NaiveComplexBatchNorm2d(int(128*channel_scale))
        self.do42d = ComplexDropout2d(drop_p)
        self.conv41d = ComplexConvTranspose2d(int(128*channel_scale), int(64*channel_scale), kernel_size=3, padding=1)
        self.bn41d = NaiveComplexBatchNorm2d(int(64*channel_scale))
        self.do41d = ComplexDropout2d(drop_p)

        self.upconv3 = ComplexConvTranspose2d(int(64*channel_scale), int(64*channel_scale), kernel_size=3, padding=1, stride=2, output_padding=1)

        self.conv33d = ComplexConvTranspose2d(int(128*channel_scale), int(64*channel_scale), kernel_size=3, padding=1)
        self.bn33d = NaiveComplexBatchNorm2d(int(64*channel_scale))
        self.do33d = ComplexDropout2d(drop_p)
        self.conv32d = ComplexConvTranspose2d(int(64*channel_scale), int(64*channel_scale), kernel_size=3, padding=1)
        self.bn32d = NaiveComplexBatchNorm2d(int(64*channel_scale))
        self.do32d = ComplexDropout2d(drop_p)
        self.conv31d = ComplexConvTranspose2d(int(64*channel_scale), int(32*channel_scale), kernel_size=3, padding=1)
        self.bn31d = NaiveComplexBatchNorm2d(int(32*channel_scale))
        self.do31d = ComplexDropout2d(drop_p)

        self.upconv2 = ComplexConvTranspose2d(int(32*channel_scale), int(32*channel_scale), kernel_size=3, padding=1, stride=2, output_padding=1)

        self.conv22d = ComplexConvTranspose2d(int(64*channel_scale), int(32*channel_scale), kernel_size=3, padding=1)
        self.bn22d = NaiveComplexBatchNorm2d(int(32*channel_scale))
        self.do22d = ComplexDropout2d(drop_p)
        self.conv21d = ComplexConvTranspose2d(int(32*channel_scale), int(16*channel_scale), kernel_size=3, padding=1)
        self.bn21d = NaiveComplexBatchNorm2d(int(16*channel_scale))
        self.do21d = ComplexDropout2d(drop_p)

        self.upconv1 = ComplexConvTranspose2d(int(16*channel_scale), int(16*channel_scale), kernel_size=3, padding=1, stride=2, output_padding=1)

        self.conv12d = ComplexConvTranspose2d(int(32*channel_scale), int(16*channel_scale), kernel_size=3, padding=1)
        self.bn12d = NaiveComplexBatchNorm2d(int(16*channel_scale))
        self.do12d = ComplexDropout2d(drop_p)
        self.conv11d = ComplexConvTranspose2d(int(16*channel_scale), label_nbr, kernel_size=3, padding=1)
    ...
    def forward(self, x1, x2):
        ...
        x3p = complex_max_pool2d(x33_1, kernel_size=2, stride=2)
        ...
        x4p = complex_max_pool2d(x43_1, kernel_size=2, stride=2)

        ####################################################
        # Stage 1
        x11 = self.do11(complex_relu(self.bn11(self.conv11(x2))))
        x12_2 = self.do12(complex_relu(self.bn12(self.conv12(x11))))
        x1p = complex_max_pool2d(x12_2, kernel_size=2, stride=2)


        # Stage 2
        x21 = self.do21(complex_relu(self.bn21(self.conv21(x1p))))
        x22_2 = self.do22(complex_relu(self.bn22(self.conv22(x21))))
        x2p = complex_max_pool2d(x22_2, kernel_size=2, stride=2)

        # Stage 3
        x31 = self.do31(complex_relu(self.bn31(self.conv31(x2p))))
        x32 = self.do32(complex_relu(self.bn32(self.conv32(x31))))
        x33_2 = self.do33(complex_relu(self.bn33(self.conv33(x32))))
        x3p = complex_max_pool2d(x33_2, kernel_size=2, stride=2)

        # Stage 4
        x41 = self.do41(complex_relu(self.bn41(self.conv41(x3p))))
        x42 = self.do42(complex_relu(self.bn42(self.conv42(x41))))
        x43_2 = self.do43(complex_relu(self.bn43(self.conv43(x42))))
        x4p = complex_max_pool2d(x43_2, kernel_size=2, stride=2)

        # Stage 4d
        x4d = self.upconv4(x4p)
        # 这个pad的方法有问题吧，只pad一边
        pad4 = ComplexReplicationPad2d((0, x43_1.size(3) - x4d.size(3), 0, x43_1.size(2) - x4d.size(2)))
        x4d = torch.cat((pad4(x4d), torch.abs(x43_1 - x43_2).type(torch.complex64)), 1)
        ...
        pad3 = ComplexReplicationPad2d((0, x33_1.size(3) - x3d.size(3), 0, x33_1.size(2) - x3d.size(2)))
        x3d = torch.cat((pad3(x3d), torch.abs(x33_1 - x33_2).type(torch.complex64)), 1)
        ...
        pad2 = ComplexReplicationPad2d((0, x22_1.size(3) - x2d.size(3), 0, x22_1.size(2) - x2d.size(2)))
        x2d = torch.cat((pad2(x2d), torch.abs(x22_1 - x22_2).type(torch.complex64)), 1)
        x22d = self.do22d(complex_relu(self.bn22d(self.conv22d(x2d))))
        x21d = self.do21d(complex_relu(self.bn21d(self.conv21d(x22d))))

        # Stage 1d
        x1d = self.upconv1(x21d)
        pad1 = ComplexReplicationPad2d((0, x12_1.size(3) - x1d.size(3), 0, x12_1.size(2) - x1d.size(2)))
        x1d = torch.cat((pad1(x1d), torch.abs(x12_1 - x12_2).type(torch.complex64)), 1)
