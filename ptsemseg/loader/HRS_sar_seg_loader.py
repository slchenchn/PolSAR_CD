...
class HRS_SAR_seg_Loader(data.Dataset):
    def __init__(
        self,
        root,
        split="train",
        ...
        # 20% val, 80% train
        file_list = os.listdir(osp.join(root, 'train'))
        if split == 'train':
    ...
    def __getitem__(self, index):
        ...
        img_path = self.root + "/" + 'train' + "/" + img_name
        lbl_path = self.root + "/" + 'train' + "_labels/" + img_name
